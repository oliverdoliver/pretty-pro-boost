    ...
    <section className="relative min-h-screen flex items-center pt-20">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="max-w-3xl">
          ...
          >
            Vi erbjuder skräddarsydda tjänster noggrant anpassade för dina specifika behov. 
            Flexibla lösningar och förstklassig service för att din fastighet alltid hålls i bästa möjliga skick.
          </motion.p>
          ...
          >
            {[
              { icon: Shield, text: "Pålitlig partner" },
              { icon: Clock, text: "Jour dygnet runt" },
              { icon: Users, text: "Personlig service" },
            ].map((item, index) => (
